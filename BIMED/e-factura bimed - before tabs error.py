...
Sales_EFACTURA["Unit Price"]=Sales_EFACTURA["Unit Price"].fillna(Sales_EFACTURA["General ledger amount"]/Sales_EFACTURA["Quantity"])
...
<cbc:TaxCurrencyCode>RON</cbc:TaxCurrencyCode>
		    ...
		    with open(f"D:/Projects/27. Efactura/BIMED/xml/SalesInvoice_{str(listaNumarFact[i]).replace('.0', '')}.xml", "w", encoding="utf-8") as f:
		        f.write(eFacturaXML)
	...
	#-------------------------------------------------------------------INVOICE IN VALUTA--------------------------------------------------------------------------------------------------
		    ...
		    # Scrie conținutul în fișierul XML
		    with open(f"D:/Projects/27. Efactura/BIMED/xml/SalesInvoiceValuta_{str(listaNumarFact[i]).replace('.0', '')}.xml", "w", encoding="utf-8") as f:
		        f.write(eFacturaXML)
...
#------------------------------CREDIT NOTE LEI--------------------------------------------------------------------------------------------------------------------------------
    ...
    # else:
	    ...
	    <cbc:CustomizationID>urn:cen.eu:en16931:2017#compliant#urn:efactura.mfinante.ro:CIUS-RO:1.0.1</cbc:CustomizationID>
			...
			# Scrie conținutul în fișierul XML
			with open(f"D:/Projects/27. Efactura/BIMED/xml/SalesCreditNote_{str(listaNumarFact[i]).replace('.0', '')}.xml", "w", encoding="utf-8") as f:
			    f.write(eFacturaXML)
...
#------------------------------CREDIT NOTE VALUTA--------------------------------------------------------------------------------------------------------------------------------
	    ...
	    <cbc:CustomizationID>urn:cen.eu:en16931:2017#compliant#urn:efactura.mfinante.ro:CIUS-RO:1.0.1</cbc:CustomizationID>
		    ...
		    # Scrie conținutul în fișierul XML
		    with open(f"D:/Projects/27. Efactura/BIMED/xml/SalesCreditNoteValuta_{str(listaNumarFact[i]).replace('.0', '')}.xml", "w", encoding="utf-8") as f:
		        f.write(eFacturaXML)
